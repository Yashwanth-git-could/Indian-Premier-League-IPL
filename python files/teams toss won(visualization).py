...
df = pd.read_csv(r'ipl\team toss won.csv')
...
plt.bar(index, y, barwidth, label='Matches')  # Total matches
plt.bar(index + barwidth, z, barwidth, label='Won')  # Matches won
plt.bar(index + 2 * barwidth, w, barwidth, label='Lost')  # Matches lost
